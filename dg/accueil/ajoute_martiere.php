...
<section class="content">
                ...
                <div class="card table-responsive">
                    <div class="card-body">
                        ...
                        <div id="table_etudiant_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"><div class="dataTables_length" id="table_etudiant_length"><label>Afficher <select name="table_etudiant_length" aria-controls="table_etudiant" class="custom-select custom-select-sm form-control form-control-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> éléments</label></div></div><div class="col-sm-12 col-md-6"><div id="table_etudiant_filter" class="dataTables_filter"><label>Rechercher :<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="table_etudiant"></label></div></div></div><div class="row"><div class="col-sm-12"><table id="table_etudiant" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="table_etudiant_info">
                            <thead>
                                <tr role="row"><th scope="col" class="sorting_asc" tabindex="0" aria-controls="table_etudiant" rowspan="1" colspan="1" aria-sort="ascending" aria-label="#: activer pour trier la colonne par ordre décroissant">#</th><th hidden="" scope="col" class="sorting" tabindex="0" aria-controls="table_etudiant" rowspan="1" colspan="1" aria-label="Code : activer pour trier la colonne par ordre croissant">Code </th><th scope="col" class="sorting" tabindex="0" aria-controls="table_etudiant" rowspan="1" colspan="1" aria-label="Libellé: activer pour trier la colonne par ordre croissant">Libellé</th><th scope="col" class="sorting" tabindex="0" aria-controls="table_etudiant" rowspan="1" colspan="1" aria-label="Coef : activer pour trier la colonne par ordre croissant">Coef </th><th hidden="" scope="col" class="sorting" tabindex="0" aria-controls="table_etudiant" rowspan="1" colspan="1" aria-label="ID Filiere : activer pour trier la colonne par ordre croissant">ID Filiere </th><th scope="col" class="sorting" tabindex="0" aria-controls="table_etudiant" rowspan="1" colspan="1" aria-label="Filiere : activer pour trier la colonne par ordre croissant">Filiere </th><th scope="col" class="sorting" tabindex="0" aria-controls="table_etudiant" rowspan="1" colspan="1" aria-label="Actions: activer pour trier la colonne par ordre croissant">Actions</th></tr>
                            </thead>
                            <tfoot>
                                <tr><th scope="col" rowspan="1" colspan="1">#</th><th hidden="" scope="col" rowspan="1" colspan="1">Code </th><th scope="col" rowspan="1" colspan="1">Libellé</th><th scope="col" rowspan="1" colspan="1">Coef </th><th hidden="" scope="col" rowspan="1" colspan="1">ID Filiere </th><th scope="col" rowspan="1" colspan="1">Filiere </th><th scope="col" rowspan="1" colspan="1">Actions</th></tr>
                            </tfoot>
                            <tbody>
                                    ...
                                    <td scope="col">Informatique</td>
                                    <td scope="col">2 </td>                                                                                                                                                             
                                    <td hidden="" scope="col">1</td>                                                                                                                                                             
                                    <td scope="col">IG</td>                                                                                                                                                             
                                    <td>
                                                                                    <a href="http://localhost/SchoolGest/view-listCompo.html/code_mat/1"><button type="button" data-placement="bottom" class="btn btn-xs btn-warning text-white detailsBtn"><i class="fas fa-folder-open" aria-hidden="true"> Add Note</i></button></a> 
                                            <a href="http://localhost/SchoolGest/view-note.html/code_mat/1"><button type="button" data-placement="bottom" class="btn btn-xs btn-success text-white"><i class="fas fa-eye" aria-hidden="true"></i> View Note</button></a>                               
                                            <a href="http://localhost/SchoolGest/show-moy.html/code_mat/1"><button type="button" data-placement="bottom" class="btn btn-xs btn-info text-white"><i class="fas fa-eye" aria-hidden="true"></i> View Moyenne</button></a>                               
                                    ...
                                    <td scope="col">Socio</td>
                                    <td scope="col">2 </td>                                                                                                                                                             
                                    <td hidden="" scope="col">2</td>                                                                                                                                                             
                                    <td scope="col">FASH</td>                                                                                                                                                             
                                    <td>
                                                                                    <a href="http://localhost/SchoolGest/view-listCompo.html/code_mat/2"><button type="button" data-placement="bottom" class="btn btn-xs btn-warning text-white detailsBtn"><i class="fas fa-folder-open" aria-hidden="true"> Add Note</i></button></a> 
                                            <a href="http://localhost/SchoolGest/view-note.html/code_mat/2"><button type="button" data-placement="bottom" class="btn btn-xs btn-success text-white"><i class="fas fa-eye" aria-hidden="true"></i> View Note</button></a>                               
                                            <a href="http://localhost/SchoolGest/show-moy.html/code_mat/2"><button type="button" data-placement="bottom" class="btn btn-xs btn-info text-white"><i class="fas fa-eye" aria-hidden="true"></i> View Moyenne</button></a>                               
                                    ...
                                    <td scope="col">Anglais</td>
                                    <td scope="col">2 </td>                                                                                                                                                             
                                    <td hidden="" scope="col">3</td>                                                                                                                                                             
                                    <td scope="col">FALLC</td>                                                                                                                                                             
                                    <td>
                                                                                    <a href="http://localhost/SchoolGest/view-listCompo.html/code_mat/3"><button type="button" data-placement="bottom" class="btn btn-xs btn-warning text-white detailsBtn"><i class="fas fa-folder-open" aria-hidden="true"> Add Note</i></button></a> 
                                            <a href="http://localhost/SchoolGest/view-note.html/code_mat/3"><button type="button" data-placement="bottom" class="btn btn-xs btn-success text-white"><i class="fas fa-eye" aria-hidden="true"></i> View Note</button></a>                               
                                            <a href="http://localhost/SchoolGest/show-moy.html/code_mat/3"><button type="button" data-placement="bottom" class="btn btn-xs btn-info text-white"><i class="fas fa-eye" aria-hidden="true"></i> View Moyenne</button></a>                               
    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <form action="http://localhost/SchoolGest/add-matiere.html" method="POST" id="form_id">
            <div class="modal-body mt-3">
                ...
                <div class="form-group">
                    ...
                    <input type="int" class="form-control" name="values[coef]" id="cout">                   
                </div>
                <div class="form-group">
                    <label for="code_fil">Filière</label>
                    <select class="form-control" aria-label="Default select example" name="values[code_fil]" id="code_fil">
...
<div class="modal fade" id="update">
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="modal-header bg-warning">
            <h4 class="modal-title">Editer une matière</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span style="color: white;" aria-hidden="true">×</span>
            </button>
        </div>
        <form action="http://localhost/SchoolGest/edit-matiere.html" method="POST" id="form_id">
            <div class="modal-body mt-3">
                <div class="form-group">
                    <label for="libelle">Libellé</label>
                    <input type="hidden" class="form-control" name="values[code_mat]" id="m_code_mat">                  
                    <input type="text" class="form-control" name="values[libelle]" id="m_libelle">                  
                </div>
                <div class="form-group">
                    <label for="coef">Coef</label>
                    <input type="number" class="form-control" name="values[coef]" id="m_coef">                   
                </div>
                <div class="form-group">
                    <label for="code_fil">Filière</label>

                    <select class="form-control" aria-label="Default select example" name="values[code_fil]" id="m_code_fil">
                        <option selected="">Choisir une filière...</option>
                                                <option value="1">IG</option>
                                                <option value="2">FASH</option>
                                                <option value="3">FALLC</option>
...
$(document).ready(function () {
    $('.updateBtn').on('click', function(){
        ...
        // alert(data[4]);
        $('#m_code_mat').val(data[1]);
        $('#m_libelle').val(data[2]);
        $('#m_coef').val(data[3]);
        selectionner('m_code_fil', data[4]);       
...
$(document).ready(function () {
    $('.deleteBtn').on('click', function(){
        ...
        document.getElementById("delete_id").href = "delete-matiere.html/code_fil/"+data[1];
...
$(function () {
    $("#table_etudiant").DataTable({
        ...
        "language" : {
            ...
            "sEmptyTable":     "Aucune matière n'est disponible pour le moment",
